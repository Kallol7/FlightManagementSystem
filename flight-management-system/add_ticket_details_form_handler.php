...
<body>
    <?php
			if(isset($_POST['Submit']))
			{
				...
				$date_of_res=date("Y-m-d", strtotime('+6 hours'));
				$flight_no=$_SESSION['flight_no'];
				$journey_date=$_SESSION['journey_date'];
				$class=$_SESSION['class'];
				$booking_status="PENDING";
				$no_of_pass=$_SESSION['no_of_pass'];
				$lounge_access=isset($_POST['lounge_access']) ? $_POST['lounge_access'] : "No";
				$priority_checkin=isset($_POST['priority_checkin']) ? $_POST['priority_checkin'] : "No";
				...
				$payment_id=NULL;
				$customer_id=strtolower($_SESSION['username']);
